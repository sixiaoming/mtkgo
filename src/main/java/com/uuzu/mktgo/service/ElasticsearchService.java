...
public class ElasticsearchService {
    ...
    /**
     * 标准画像接口es查询 ,String sortField,int pageSize
     * 
    ...
    public Map<String, String> getRowKeyByEs(PersonaSummary personaSummary, String countfield, String operation) throws Exception {
        ...
        String[] fields = { "income", "sysver", "brand_name", "carrier", "segment", "price_range", "agebin", "network", "occupation", "edu", "price", "house", "screensize", "car", "married", "kids", "gender" };
