        ...
        public String call() {
            try {
                if(type.contains("brand")){
                    PersonaSummary thisPersonSummary =new PersonaSummary(personaSummary.getModel(),personaSummary.getBrand(),personaSummary.getPrice_range(),personaSummary.getCountry(),personaSummary.getProvince(),month);
                    ...
                    PersonaSummary unknownPersonSummary =new PersonaSummary(personaSummary.getModel(),personaSummary.getBrand(),personaSummary.getPrice_range(),personaSummary.getCountry(),personaSummary.getProvince(),month);
