...
public class ExportControl {
    ...
    public void exportAll(@RequestParam(value = "brand", required = false) String brand, //
                          ...
                          @RequestParam(value = "reports", required = true) String reports, HttpServletResponse response) {
        ...
        try {
            ...
            if (resources != null && resources.length > 0) {
                ...
                // FileInputStream(ResourceUtils.getFile("classpath:excel-templates/MKTGO-导出报告.xls")));
    ...
    public void export(@RequestParam(value = "brand", required = false) String brand, @RequestParam(value = "model", required = false) String model, @RequestParam(value = "reports", required = true) String reports,
