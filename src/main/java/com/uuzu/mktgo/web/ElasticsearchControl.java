...
public class ElasticsearchControl {
    ...
    public ResponseEntity<String> query() {
        try {
            ...
            // PersonaSummaryHbaseModel personaSummaryHbaseModel = hbaseTemplate.get("persona_summary", row_key,
            // (result1, arg1) -> {
            // if (!result1.isEmpty()) {
            // PersonaSummaryHbaseModel personaSummaryHbaseModel1 = new PersonaSummaryHbaseModel();
            // personaSummaryHbaseModel1.setImei_count(Bytes.toString(result1.getValue("cf".getBytes(),
            // "imei_count".getBytes())));
            // personaSummaryHbaseModel1.setImei_count_incr(Bytes.toString(result1.getValue("cf".getBytes(),
            // "imei_count_incr".getBytes())));
            ...
            //
            //
            // // PersonaSummaryHbaseModel personaSummaryHbaseModel = hbaseTemplate.get("persona_summary",
            // "23=201710\u00010=华为P9\u00011=HUAWEI\u00013=cn\u00016=1", (result1, arg1) -> {
            // // if (!result1.isEmpty()) {
            // // PersonaSummaryHbaseModel personaSummaryHbaseModel1 = new PersonaSummaryHbaseModel();
            // // personaSummaryHbaseModel1.setImei_count(Bytes.toString(result1.getValue("cf".getBytes(),
            // "imei_count".getBytes())));
