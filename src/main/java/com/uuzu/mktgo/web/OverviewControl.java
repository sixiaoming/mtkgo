...
public class OverviewControl {
    ...
    @ApiImplicitParams({ @ApiImplicitParam(paramType = "form", name = "price", dataType = "String", required = false, value = "价位"),
    ...
    public ResponseEntity<OverviewModel> overview_all(@RequestParam(value = "date", required = false) String date,//
    ...
    @ApiImplicitParams({ @ApiImplicitParam(paramType = "form", name = "brand", dataType = "String", required = true, value = "品牌"),
            ...
            @ApiImplicitParam(paramType = "form", name = "province", dataType = "String", required = false, value = "省份"),
            @ApiImplicitParam(paramType = "form", name = "date", dataType = "String", required = false, value = "时间") })
    public ResponseEntity<OverviewModel> overview_brand(@RequestParam(value = "brand", required = true) String brand, //
    ...
    @ApiImplicitParams({ @ApiImplicitParam(paramType = "form", name = "model", dataType = "String", required = true, value = "机型"),
            @ApiImplicitParam(paramType = "form", name = "price", dataType = "String", required = false, value = "价位"),
            @ApiImplicitParam(paramType = "form", name = "country", dataType = "String", required = false, value = "国家"),
            @ApiImplicitParam(paramType = "form", name = "province", dataType = "String", required = false, value = "省份"),
            @ApiImplicitParam(paramType = "form", name = "date", dataType = "String", required = false, value = "时间") })
    public ResponseEntity<ModelOverviewModel> overview_model(@RequestParam(value = "model", required = true) String model, //
                                                             @RequestParam(value = "date", required = false) String date,//
                                                             @RequestParam(value = "price", required = false) String price, //
                                                             @RequestParam(value = "country", required = false) String country,//
                                                             @RequestParam(value = "province", required = false) String province) {
