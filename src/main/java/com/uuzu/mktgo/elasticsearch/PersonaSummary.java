...
@NoArgsConstructor
@AllArgsConstructor
@Document(indexName = "rp_mobeye_mktgo", type = "persona_summary", shards = 5, refreshInterval = "-1")
public class PersonaSummary {
    ...
    public PersonaSummary(String model, String brand, String price_range, String country, String province,String mnt) {
        this.brand = brand;
        this.model = model;
